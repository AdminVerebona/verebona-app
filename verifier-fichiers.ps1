...
$fichiers = @(
  ...
  @{ P = 'package.json'; H = '48b7c6c4799369c4' },
  ...
  @{ P = 'scripts/reclassify-documents.ts'; H = '5420a38eedc3d190' },
  ...
  @{ P = 'src/app/(dashboard)/documents/classement/page.tsx'; H = 'bbc97e14e968aa36' },
  ...
  @{ P = 'src/app/api/admin/notifications/health/route.ts'; H = 'b2ae971389910c81' },
  @{ P = 'src/app/api/admin/notifications/reemit/route.ts'; H = '0afb2480686d7152' },
  ...
  @{ P = 'src/app/api/auth/resend-verification/route.ts'; H = 'f16813a5e85b2b1b' },
  ...
  @{ P = 'src/app/api/cron/ai/corpus-run/route.ts'; H = 'a0e0729f29e332c3' },
  @{ P = 'src/app/api/cron/ai/purge-assistant-logs/route.ts'; H = '385b4fd0d91e38fd' },
  @{ P = 'src/app/api/cron/ai/switchover-readiness/route.ts'; H = '88d88bcf0a48c301' },
  @{ P = 'src/app/api/cron/db-inspect/route.ts'; H = '7fa2004c2acdde8a' },
  @{ P = 'src/app/api/cron/documents/reclassify/route.ts'; H = '57e2f2eba7252556' },
  @{ P = 'src/app/api/cron/legal/verify-integrity/route.ts'; H = '0838ab465b2c5039' },
  @{ P = 'src/app/api/cron/seed/route.ts'; H = '08f3bb9270ef7964' },
  ...
  @{ P = 'src/app/api/health/route.ts'; H = 'ea1d062c5eaa821b' },
  @{ P = 'src/app/api/legal/acceptances/route.ts'; H = 'a5b87c365c5b03f6' },
  @{ P = 'src/app/api/legal/cgvu/current/route.ts'; H = 'a3e411ce37553e55' },
  ...
  @{ P = 'src/app/api/users/route.ts'; H = '4f3e72f93fa5d05f' },
  ...
  @{ P = 'src/app/cgvu/route.ts'; H = '5576c44a3e63e8e0' },
  ...
  @{ P = 'src/components/Footer.tsx'; H = '649835714bfdb7e0' },
  @{ P = 'src/components/LandingFooter.tsx'; H = 'bc58ad03eda4899a' },
  @{ P = 'src/components/__tests__/footer-links.test.ts'; H = '5bfbab7a9a494c71' },
  ...
  @{ P = 'src/components/assets/AssetDocumentsByCategory.tsx'; H = '81bd64d90b24995d' },
  @{ P = 'src/components/documents/CategoryAccordion.tsx'; H = '66d30b8c5359692a' },
  @{ P = 'src/components/documents/DocumentCard.tsx'; H = 'de4559f77d720e29' },
  @{ P = 'src/components/documents/DocumentClassificationSection.tsx'; H = '342ca106349bee9e' },
  @{ P = 'src/components/documents/DocumentsView.tsx'; H = '3387b9961cbb31e9' },
  @{ P = 'src/components/documents/SortFilterDrawer.tsx'; H = '25bcf081b296732a' },
  @{ P = 'src/components/documents/__tests__/document-components.test.ts'; H = '5460533f3e83ecc7' },
  ...
  @{ P = 'src/db/migrations/0054_enum_check_constraints.sql'; H = 'b00fb9fd05ee0634' },
  @{ P = 'src/db/migrations/0055_db_integrity.sql'; H = '6c3a3e49c0dd87f8' },
  ...
  @{ P = 'src/db/migrations/0115_legal_document_versions.sql'; H = 'df202e741ad6ff0e' },
  ...
  @{ P = 'src/db/migrations/0119_document_categories.sql'; H = 'b4df4cd199e63292' },
  @{ P = 'src/db/migrations/0120_classification_source_rule.sql'; H = '2582f7c90a3e7f8c' },
  @{ P = 'src/db/migrations/0121_widen_redefined_constraints.sql'; H = '736d44bd29a39de9' },
  @{ P = 'src/db/seeds/account_membership_email_templates.ts'; H = '70f31e3db8890ac5' },
  ...
  @{ P = 'src/db/seeds/email_settings.ts'; H = 'f94e23b61fb59fb7' },
  @{ P = 'src/db/seeds/email_templates.ts'; H = 'a6e12efd314f20c0' },
  @{ P = 'src/db/seeds/email_templates_system.ts'; H = 'd491a051fc4755c0' },
  @{ P = 'src/db/seeds/email_templates_trial.ts'; H = '33f21387c07ef9f2' },
  ...
  @{ P = 'src/lib/database-diagnostic.ts'; H = '2b7d202775e2cc73' },
  ...
  @{ P = 'src/services/ai/source-analysis/__tests__/lot-notification.test.ts'; H = '74bcd036b274499a' },
  @{ P = 'src/services/ai/source-analysis/__tests__/web-link-entrypoint.test.ts'; H = '5565a36411b80467' },
  @{ P = 'src/services/ai/source-analysis/lot-notification.ts'; H = '8d3959b980170ae8' },
  @{ P = 'src/services/ai/source-analysis/pipeline.ts'; H = 'd1e3d4cc52a34cd9' },
  ...
  @{ P = 'src/services/documents/__tests__/reclassify.test.ts'; H = 'ff8483b46a38dd8e' },
  ...
  @{ P = 'src/services/documents/reclassify.service.ts'; H = 'ca5b12c748e998be' },
  ...
  @{ P = 'src/services/notifications/__tests__/notification-health.test.ts'; H = '1e6e990f426292f8' },
  @{ P = 'src/services/notifications/notification-health.service.ts'; H = '08393ad66dd0a8ea' },
  @{ P = 'src/services/notifications/notification-reemission.service.ts'; H = '227ba577758f6d91' },
