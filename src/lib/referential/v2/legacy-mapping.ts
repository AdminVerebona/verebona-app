...
const DIRECT_TYPE_MAP: Readonly<Record<string, string>> = {
  ...
  // Relevés en préproduction : absents du plan initial, ils forçaient un appel
  // modèle là où la correspondance est certaine.
  ACTE_NOTARIE: 'PROPERTY_TITLE',
  RAPPORT_ENTRETIEN: 'MAINTENANCE_REPORT',
  CONTRAT_ASSURANCE: 'INSURANCE_POLICY',
